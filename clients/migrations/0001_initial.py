...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vendor_no', models.CharField(max_length=20, null=True, unique=True, verbose_name='Vendor id')),
                ('name', models.CharField(max_length=100, null=True, verbose_name='Vendor name')),
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ims_auth.address')),
                ('alternate_address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='clients.alternateaddr')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('customer_no', models.CharField(max_length=20, null=True, unique=True, verbose_name='Customer id')),
                ('name', models.CharField(max_length=100, null=True, verbose_name='Customer name')),
                ('email', models.EmailField(max_length=25, null=True)),
                ('phone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None, unique=True)),
                ('alternate_phone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None)),
                ('date_created', models.DateTimeField(auto_now_add=True, null=True)),
